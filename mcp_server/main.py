...
from models import (
    ApiOrdersExtendsearchOrdersPostRequest,
    ApiOrdersPvtDocumentOrderIdCancelPostRequest,
    ApiOrdersPvtDocumentOrderIdCancelPostResponse,
    ApiOrdersPvtDocumentOrderIdGetResponse,
    ApiOrdersPvtDocumentOrderIdInvoicesPostResponse,
...
| `SumOfSquares` | object | Paging Details Object | """,
    tags=['order_lifecycle_management'],
    security=[
...
def list_orders2(
    ...
    body: ApiOrdersExtendsearchOrdersPostRequest = None,
):
    """
    List orders
    """
...
def cancel_order2(
    ...
    accept: str = Header(..., alias='Accept'),
    order_id: str = Path(..., alias='orderId'),
    body: ApiOrdersPvtDocumentOrderIdCancelPostRequest = None,
):
    """
    Cancel order
    """
...
> The `Notify invoice` resource is needed to use this API request. This is included in `OMS - Full access` and `IntegrationProfile - Fulfillment Oms`, among other default roles available in the Admin. Learn more about the [License manager roles and resources](https://help.vtex.com/en/tutorial/roles--7HKK5Uau2H6wxE1rH5oRbc#). """,
    tags=['invoice_status_updates'],
    security=[
        APIKeyHeader(name="X-VTEX-API-AppKey"),
        APIKeyHeader(name="X-VTEX-API-AppToken"),
    ],
)
def invoice_notification2(
    content__type: str = Header(..., alias='Content-Type'),
    accept: str = Header(..., alias='Accept'),
    order_id: str = Path(..., alias='orderId'),
...
| `paymentId` | string | Payment ID | """,
    tags=['payment_status_notifications', 'invoice_status_updates'],
    security=[
        APIKeyHeader(name="X-VTEX-API-AppKey"),
        APIKeyHeader(name="X-VTEX-API-AppToken"),
    ],
)
def send_payment_notification2(
    content__type: str = Header(..., alias='Content-Type'),
    accept: str = Header(..., alias='Accept'),
    order_id: str = Path(..., alias='orderId'),
